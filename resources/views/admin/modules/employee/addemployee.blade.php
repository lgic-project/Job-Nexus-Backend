...
<form method="post" action="{{route('employee-save')}}" enctype="multipart/form-data">
    ...
    <div class=" row mb-4">
        <div class="col">
            <div data-mdb-input-init class="form-outline">
                <input type="text" id="form6Example1" class="form-control" name="employee_first_name" />
        ...
        <div class="col">
            <div data-mdb-input-init class="form-outline">
                <input type="text" id="form6Example2" class="form-control" name="employee_middle_name" />
        ...
        <div class="col">
            <div data-mdb-input-init class="form-outline">
                <input type="text" id="form6Example2" class="form-control" name="employee_last_name" />
    ...
    <div class="row mb-4">
        ...
        <div class="col">
            <div data-mdb-input-init class="form-outline ">
                <input type="text" id="form6Example4" class="form-control" name="employee_address" />
        ...
        <div class="col">
            <div data-mdb-input-init class="form-outline ">
                <input type="email" id="form6Example3" class="form-control" name="employee_email" />
        ...
        <div class="col">
            <div data-mdb-input-init class="form-outline ">
                <input type="password" id="form6Example4" class="form-control" name="employee_password" />
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-3">
            <div data-mdb-input-init class="form-outline ">
                ...
                <label class="form-label" for="form6Example3">Resume</label>
            </div>
        ...
        <div class="col">
            <div data-mdb-input-init class="form-outline ">
                <input type="text" id="form6Example4" class="form-control" name="employee_contact" />
    ...
    <div class="mb-3">
        ...
        <input type="textarea" id="form6Example4" class="form-control" name="employee_description" />
    </div>
